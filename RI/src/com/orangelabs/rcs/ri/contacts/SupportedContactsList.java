...
public class SupportedContactsList extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mCnxManager == null
                || !mCnxManager.isServiceConnected(RcsServiceName.CONTACTS)) {
            Utils.showMessageAndExit(this, getString(R.string.label_service_not_available),
                    mExitOnce);
            return;
        }
        mCnxManager.startMonitorServices(this, mExitOnce, RcsServiceName.CONTACTS);
    }
    ...
    private void updateList() {
        try {
            ...
            Set<RcsContact> supportedContacts = mCnxManager.getContactsApi()
