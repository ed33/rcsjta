...
public class RcsSettingsTest extends AndroidTestCase {
    ...
    public void testRcsSettingsInsertRuntimeException() {
        ...
        values.put(RcsServiceConfiguration.Settings.KEY,
                RcsServiceConfiguration.Settings.MESSAGING_MODE);
        values.put(RcsServiceConfiguration.Settings.VALUE,
                RcsServiceConfiguration.Settings.MessagingModes.SEAMLESS);
    ...
    public void testRcsSettingsQueryProjection() {
        ...
        try {
            ...
            String[] whereArgs = new String[] {
                RcsServiceConfiguration.Settings.CONFIGURATION_VALIDITY
            };
    ...
    public void testRcsSettingsQueryByKeyBis() {
        ...
        try {
            String where = new StringBuilder(RcsServiceConfiguration.Settings.KEY).append("= '")
                    .append(RcsServiceConfiguration.Settings.CONFIGURATION_VALIDITY).append("'")
                    .toString();
    ...
    public void testRcsSessionsUpdateByKey() {
        ...
        String[] whereArg = new String[] {
            Settings.DEFAULT_MESSAGING_METHOD
        };
