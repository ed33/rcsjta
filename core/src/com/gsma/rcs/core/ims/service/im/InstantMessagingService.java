...
public class InstantMessagingService extends ImsService {
    ...
    public void receiveOneToOneHttpFileTranferInvitation(SipRequest invite,
        ...
        /* Reject if file is too big or size exceeds device storage capacity. */
        ...
        if (filetransferSession.getFileicon() != null) {
            try {
                ...
                handleFileTransferInvitationRejected(invite,
                        FileTransfer.ReasonCode.REJECTED_MEDIA_FAILED);
                sendErrorResponse(invite, Response.DECLINE);
                return;
        ...
        getImsModule()
                .getCore()
                .getListener()
                .handleOneToOneFileTransferInvitation(filetransferSession, oneToOneChatSession,
