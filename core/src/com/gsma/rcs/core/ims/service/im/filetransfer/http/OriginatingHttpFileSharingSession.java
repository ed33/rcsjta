...
import com.gsma.rcs.core.ims.service.im.chat.FileTransferMessage;
    ...
    protected void sendResultToContact(byte[] result) {
        ...
        if ((result != null) && (FileTransferUtils.parseFileTransferHttpDocument(result) != null)) {
            ...
            if (chatSession != null) {
                ...
                FileTransferMessage firstMsg = ChatUtils.createFileTransferMessage(
                        getRemoteContact(), fileInfo, false, msgId);
                try {
