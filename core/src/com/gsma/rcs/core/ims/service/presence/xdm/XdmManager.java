    ...
    public HttpResponse setRcsList() {
        try {
            ...
            String content = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
                    ...
                    + HttpUtils.CRLF + "<service uri=\"" + user + ";pres-list=rcs\">"
                    + HttpUtils.CRLF +

                    "<resource-list>" + resList + "</resource-list>" + HttpUtils.CRLF +

                    "<packages>" + HttpUtils.CRLF + " <package>presence</package>" + HttpUtils.CRLF
    ...
    public HttpResponse setResourcesList() {
        try {
            ...
            String content = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + HttpUtils.CRLF
                    ...
                    "<list name=\"oma_buddylist\">" + HttpUtils.CRLF + " <external anchor=\""
                    + resList + "@name=%22rcs%22%5D\"/>" + HttpUtils.CRLF + "</list>"
                    + HttpUtils.CRLF +

                    "<list name=\"oma_grantedcontacts\">" + HttpUtils.CRLF + " <external anchor=\""
                    + resList + "@name=%22rcs%22%5D\"/>" + HttpUtils.CRLF + "</list>"
                    + HttpUtils.CRLF +

                    "<list name=\"oma_blockedcontacts\">" + HttpUtils.CRLF + " <external anchor=\""
                    + resList + "@name=%22rcs_blockedcontacts%22%5D\"/>" + HttpUtils.CRLF
                    + " <external anchor=\"" + resList + "@name=%22rcs_revokedcontacts%22%5D\"/>"
    ...
    public HttpResponse setPresenceRules() {
        try {
            ...
            String content = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
                    ...
                    "<cr:rule id=\"wp_prs_allow_own\">" + HttpUtils.CRLF + " <cr:conditions>"
                    + HttpUtils.CRLF + "  <cr:identity><cr:one id=\""
                    + ImsModule.IMS_USER_PROFILE.getPublicUri() + "\"/></cr:identity>"
                    + HttpUtils.CRLF + " </cr:conditions>" + HttpUtils.CRLF
                    + " <cr:actions><pr:sub-handling>allow</pr:sub-handling></cr:actions>"
                    + HttpUtils.CRLF + " <cr:transformations>" + HttpUtils.CRLF
                    ...
                    + HttpUtils.CRLF + "  <pr:provide-all-attributes/>" + HttpUtils.CRLF
                    + " </cr:transformations>" + HttpUtils.CRLF + "</cr:rule>" + HttpUtils.CRLF +
                    ...
                    "<cr:rule id=\"wp_prs_grantedcontacts\">" + HttpUtils.CRLF + " <cr:conditions>"
                    + HttpUtils.CRLF + " <ocp:external-list>" + HttpUtils.CRLF
                    + "  <ocp:entry anc=\"" + grantedList + "\"/>" + HttpUtils.CRLF
                    + " </ocp:external-list>" + HttpUtils.CRLF + " </cr:conditions>"
                    + HttpUtils.CRLF
                    + " <cr:actions><pr:sub-handling>allow</pr:sub-handling></cr:actions>"
                    + HttpUtils.CRLF + " <cr:transformations>" + HttpUtils.CRLF
                    + "   <pr:provide-services><pr:all-services/></pr:provide-services>"
                    ...
                    "<cr:rule id=\"wp_prs_blockedcontacts\">" + HttpUtils.CRLF + " <cr:conditions>"
                    + HttpUtils.CRLF + "  <ocp:external-list>" + HttpUtils.CRLF
                    + "  <ocp:entry anc=\"" + blockedList + "\"/>" + HttpUtils.CRLF
                    + " </ocp:external-list>" + HttpUtils.CRLF + " </cr:conditions>"
                    + HttpUtils.CRLF
                    + " <cr:actions><pr:sub-handling>block</pr:sub-handling></cr:actions>"
                    + HttpUtils.CRLF + "</cr:rule>" + HttpUtils.CRLF + "</cr:ruleset>";
    ...
    public HttpResponse uploadEndUserPhoto(PhotoIcon photo) {
        try {
            ...
            String content = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + HttpUtils.CRLF
                    ...
                    + "<encoding>base64</encoding>" + HttpUtils.CRLF + "<data>" + data + "</data>"
                    + HttpUtils.CRLF + "</content>";
