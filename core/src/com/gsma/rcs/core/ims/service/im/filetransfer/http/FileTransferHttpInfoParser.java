...
public class FileTransferHttpInfoParser extends DefaultHandler {
    /*
     * File-Transfer HTTP SAMPLE: <?xml version="1.0" encoding=”UTF-8”?> <file> <file-info
     * type="thumbnail"> <file-size>[thumbnail size in bytes]</file-size> <content-type>[MIME-type
     * for thumbnail]</content-type> <data url = "[HTTP URL for the thumbnail]" until =
     * "[validity of the thumbnail]"/> </file-info> <file-info type="file"> <file-size>[file size in
     * bytes]</file-size> <file-name>[original file name]</file-name> <content-type>[MIME-type for
     * file]</content-type> <data url = "[HTTP URL for the file]" until = "[validity of the file]"/>
     * </file-info> <file>
     */
    ...
    public void endElement(String namespaceURL, String localName, String qname) {
        if (localName.equalsIgnoreCase("file-size")) {
            if ((ftInfo != null && ftInfo.getFileThumbnail() != null)
                    || (ftInfo != null && thumbnailInfo == null)) {
