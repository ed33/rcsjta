...
public class ChatServiceImpl extends IChatService.Stub {
     ...
     * 
     * @param contact List of contact IDs
    ...
    public ChatServiceConfiguration getConfiguration() {
        return new ChatServiceConfiguration(mRcsSettings.isImAlwaysOn(),
                mRcsSettings.isStoreForwardWarningActivated(), mRcsSettings.getChatIdleDuration(),
                mRcsSettings.getIsComposingTimeout(), mRcsSettings.getMaxChatParticipants(),
                mRcsSettings.getMinGroupChatParticipants(), mRcsSettings.getMaxChatMessageLength(),
                ...
                mRcsSettings.isRespondToDisplayReports(), mRcsSettings.getMaxGeolocLabelLength(),
