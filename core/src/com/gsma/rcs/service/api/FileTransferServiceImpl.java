...
public class FileTransferServiceImpl extends IFileTransferService.Stub {
    ...
    public FileTransferServiceConfiguration getConfiguration() {
        return new FileTransferServiceConfiguration(mRcsSettings.getWarningMaxFileTransferSize(),
                ...
                mRcsSettings.getMaxFileTransferSessions(), mRcsSettings.getImageResizeOption()
                        .toInt());
    }
