...
public class VideoSharingImpl extends IVideoSharing.Stub implements VideoStreamingSessionListener {
        ...
        switch (error.getErrorCode()) {
            ...
            default:
                throw new IllegalArgumentException(
                        "Unknown reason in VideoSharingImpl.toStateAndReasonCode; error=" + error
                                + "!");
        }
    }
    ...
    private void handleSessionRejected(int reasonCode) {
        ...
        synchronized (lock) {
            ...
            mPersistentStorage.setStateAndReasonCode(VideoSharing.State.ABORTED, reasonCode);
    ...
    public void handleSessionAborted(int reason) {
        ...
        synchronized (lock) {
            ...
            if (session != null && session.getDialogPath().isSessionCancelled()) {
                ...
                mBroadcaster.broadcastStateChanged(getRemoteContact(), mSharingId,
                        VideoSharing.State.ABORTED, reasonCode);
                mPersistentStorage.setDuration((System.currentTimeMillis() - startedAt) / 100);
            }
        }
    }
    ...
    public void handleSessionTerminatedByRemote() {
        ...
        synchronized (lock) {
            ...
            mBroadcaster.broadcastStateChanged(getRemoteContact(), getSharingId(),
                    VideoSharing.State.ABORTED, ReasonCode.ABORTED_BY_REMOTE);
        }
    }
    ...
    public void handleSharingError(ContentSharingError error) {
        ...
        synchronized (lock) {
            ...
            mBroadcaster.broadcastStateChanged(getRemoteContact(), mSharingId, state, reasonCode);
        }
    }
