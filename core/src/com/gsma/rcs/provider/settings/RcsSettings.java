...
import com.gsma.rcs.provider.settings.RcsSettingsData.ImageResizeOption;
...
public class RcsSettings {
     ...
     * @param defaultValude the default value
     ...
     * @param key the key field
     * @param defaultValue the default value
     * @param tryReadFromCache try to read from cache
     * @return the value field
     */
     ...
     * @param key the key field
     * @param defaultValue the default value
     * @param tryReadFromCache Try to read from the cache
     * @return the value field or defaultValue (if read fails)
     */
     ...
     * @param key the key field
     * @param value the integer value
     * @param updateCache update the cache
     */
     ...
     *
     * @param key Key
     * @param tryReadFromCache Try to read parameter from cache
     * @return Value
     */
    ...
    public int getMinStorageCapacity() {
        return readInteger(RcsSettingsData.MIN_STORAGE_CAPACITY,
    ...
    public String getUserProfileImsDisplayName() {
        return readString(RcsSettingsData.USERPROFILE_IMS_DISPLAY_NAME,
                RcsSettingsData.DEFAULT_USERPROFILE_IMS_DISPLAY_NAME, false);
    }
    ...
    public int getMaxPhotoIconSize() {
        return readInteger(RcsSettingsData.MAX_PHOTO_ICON_SIZE,
    ...
    public int getMaxFileTransferSize() {
        return readInteger(RcsSettingsData.MAX_FILE_TRANSFER_SIZE,
    ...
    public int getWarningMaxFileTransferSize() {
        return readInteger(RcsSettingsData.WARN_FILE_TRANSFER_SIZE,
    ...
    public int getMaxImageSharingSize() {
        return readInteger(RcsSettingsData.MAX_IMAGE_SHARE_SIZE,
    ...
    public AuthenticationProcedure getImsAuthenticationProcedureForMobile() {
        ...
        try {
            ...
            return AuthenticationProcedure
                    .valueOf(RcsSettingsData.DEFAULT_IMS_AUTHENT_PROCEDURE_MOBILE);
        }
    }
    ...
    public AuthenticationProcedure getImsAuthenticationProcedureForWifi() {
        ...
        try {
            ...
            return AuthenticationProcedure
                    .valueOf(RcsSettingsData.DEFAULT_IMS_AUTHENT_PROCEDURE_WIFI);
        }
    }
    ...
    public NetworkAccessType getNetworkAccess() {
        int type = readInteger(RcsSettingsData.NETWORK_ACCESS,
    ...
    public int getMaxFileIconSize() {
        return readInteger(RcsSettingsData.MAX_FILE_ICON_SIZE,
    ...
    public GsmaRelease getGsmaRelease() {
        int release = readInteger(RcsSettingsData.KEY_GSMA_RELEASE,
    ...
    public MessagingMode getMessagingMode() {
        int mode = readInteger(RcsSettingsData.KEY_MESSAGING_MODE,
    ...
    public ImageResizeOption getImageResizeOption() {
        int option = readInteger(RcsSettingsData.KEY_IMAGE_RESIZE_OPTION,
    ...
    public DefaultMessagingMethod getDefaultMessagingMethod() {
        int method = readInteger(RcsSettingsData.KEY_DEFAULT_MESSAGING_METHOD,
                RcsSettingsData.DEFAULT_KEY_DEFAULT_MESSAGING_METHOD, false);
        try {
            return DefaultMessagingMethod.valueOf(method);
        } catch (Exception e) {
            return DefaultMessagingMethod
                    .valueOf(RcsSettingsData.DEFAULT_KEY_DEFAULT_MESSAGING_METHOD);
        }
    }
