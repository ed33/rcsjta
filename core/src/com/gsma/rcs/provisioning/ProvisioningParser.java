            ...
            do {
                ...
                if (msgCapValidity == null) {
                    if ((msgCapValidity = getValueByParamName("msgCapValidity", childnode,
                        ...
                        mRcsSettings.writeLong(RcsSettingsData.MSG_CAP_VALIDITY_PERIOD,
                                validity);
                    }
                }
            } while ((childnode = childnode.getNextSibling()) != null);
        ...
        if (childnode != null) {
            do {
                if (ftHTTPCapAlwaysOn == null) {
                    if ((ftHTTPCapAlwaysOn = getValueByParamName("ftHTTPCapAlwaysOn",
                            childnode, TYPE_INT)) != null) {
                    ...
                    if (attributes.getLength() > 0) {
                        ...
                        if (typenode != null) {
                            ...
                            if (nodeValue.equalsIgnoreCase("IMS")) {
                                ...
                                parseSupl(childnode);
                            } else if (nodeValue.equalsIgnoreCase(
                                    "SERVICEPROVIDEREXT")) {
                                parseServiceProviderExt(childnode);
                            }
                        }
