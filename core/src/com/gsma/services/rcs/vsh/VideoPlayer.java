 ...
 * service. The video player is implemented in the application side. The video player captures the
 * video from the device camera, encodes the video into the selected format and streams the encoded
