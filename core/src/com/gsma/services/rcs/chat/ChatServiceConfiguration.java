...
public class ChatServiceConfiguration {
     ...
     * @hide
     */
    public ChatServiceConfiguration(boolean imAlwaysOn, boolean warnSF, int chatTimeout,
            int isComposingTimeout, int maxGroupChatParticipants, int minGroupChatParticipants,
            int maxMsgLengthOneToOneChat, int maxMsgLengthGroupChat, int groupChatSubjectMaxLength,
            boolean smsFallback, boolean respondToDisplayReports, int maxGeolocLabelLength,
