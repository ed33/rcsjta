...
public class MultimediaSessionService extends RcsService {
    ...
    public MultimediaMessagingSession initiateMessagingSession(String serviceId, ContactId contact)
        ...
        if (api != null) {
            try {
                IMultimediaMessagingSession sessionIntf = api.initiateMessagingSession(serviceId,
                        contact);
                if (sessionIntf != null) {
    ...
    public MultimediaStreamingSession initiateStreamingSession(String serviceId, ContactId contact)
        ...
        if (api != null) {
            try {
                IMultimediaStreamingSession sessionIntf = api.initiateStreamingSession(serviceId,
                        contact);
                if (sessionIntf != null) {
