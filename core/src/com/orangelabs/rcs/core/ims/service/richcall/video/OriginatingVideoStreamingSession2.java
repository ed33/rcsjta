 ...
 * @author hlxn7157
 */
public class OriginatingVideoStreamingSession2 extends VideoStreamingSession {
    /**
     * The logger
     */
	 ...
	 */
	private DefaultVideoPlayer defaultPlayer; 
     ...
     */
    public OriginatingVideoStreamingSession2(ImsService parent, VideoDescriptor descriptor, Surface surface,
    	...
    	defaultPlayer = new DefaultVideoPlayer(descriptor, surface); 
    }
    ...
    public void run() {
        try {
            ...
            String videoSdp = VideoSdpBuilder.buildSdpOfferWithOrientation(defaultPlayer.getSupportedCodecs(), defaultPlayer.getLocalRtpPort());
    ...
    public void prepareMediaSession() throws Exception {
        ...
        VideoCodec selectedVideoCodec = VideoCodecManager.negociateVideoCodec(
        		defaultPlayer.getSupportedCodecs(), proposedCodecs);
        ...
        if (extensionHeader != null) {
        	// TODO defaultPlayer.setOrientationHeaderId(extensionHeader.getExtensionId());
        }
        
        // Set the video player remote info
        defaultPlayer.setRemoteInfo(selectedVideoCodec, remoteHost, remotePort);        
