...
public class MultimediaMessagingSessionImpl extends IMultimediaMessagingSession.Stub implements
    ...
    private void handleSessionRejected(int reasonCode) {
        ...
        synchronized (lock) {
            mBroadcaster.broadcastStateChanged(getRemoteContact(), sessionId,
    ...
    public void handleSessionStarted() {
        ...
        synchronized (lock) {
            mBroadcaster.broadcastStateChanged(getRemoteContact(), getSessionId(),
    ...
    public void handleSessionAborted(int reason) {
        ...
        synchronized (lock) {
            ...
            mBroadcaster.broadcastStateChanged(getRemoteContact(), mSessionId,
    ...
    public void handleReceiveData(byte[] data) {
        synchronized (lock) {
            ...
            mBroadcaster.broadcastMessageReceived(getRemoteContact(), mSessionId, data);
        }
    }
    ...
    public void handleSessionInvited() {
        ...
        GenericSipMsrpSession session = mSipService.getGenericSipMsrpSession(mSessionId);
        mBroadcaster.broadcastInvitation(getSessionId(),
