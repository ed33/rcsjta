...
/**
 * A class for representing a serviceId revocation. The revocation is based on a duration. If the duration equals: -1 : the serviceId is
 * authorized 0 : the serviceId is revoked for ever >0 : the serviceId is revoked until the duration + currentTime
 * 
 */
public class RevocationData {
	 ...
	 * Database URI
	 */
	public static final Uri CONTENT_URI = Uri.parse("content://com.orangelabs.rcs.security/revocation");
