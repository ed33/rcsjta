...
public class MessagingLog implements IGroupChatLog, IMessageLog, IFileTransferLog,
     ...
     * (non-Javadoc)
     * @see
     * com.orangelabs.rcs.provider.messaging.IMessageLog#addSpamMessage(com.orangelabs.rcs.core.
     * ims.service.im.chat.InstantMessage)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * com.orangelabs.rcs.provider.messaging.IMessageLog#addIncomingOneToOneChatMessage(com.orangelabs
     * .rcs.core.ims.service.im.chat.InstantMessage))
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * com.orangelabs.rcs.provider.messaging.IMessageLog#addOutgoingOneToOneChatMessage(com.orangelabs
     * .rcs.core.ims.service.im.chat.InstantMessage, int,int)
     */
    @Override
