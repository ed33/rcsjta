...
public abstract class FtHttpResume {
    ...
    /**
     * The direction TODO : The type of direction is temporarily changed to an int now and will be
     * changed to an enum as part of the implementation of CR031.
     */
    ...
    public FtHttpResume(int direction, Uri file, String fileName, String mimeType, long size,
            Uri fileIcon, ContactId contact, String chatId, String fileTransferId, boolean isGroup) {
    ...
    public String toString() {
        return "FtHttpResume [date=" + date + ", dir=" + direction + ", file=" + file
                + ", fileName=" + fileName + ",fileIcon=" + fileIcon + "]";
    }
