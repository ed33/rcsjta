...
public final class ContactsManager {
    ...
    private static final String SELECTION_RAPB_IM_BLOCKED = new StringBuilder(
            RichAddressBookData.KEY_IM_BLOCKED).append("=")
            .append(RichAddressBookData.BLOCKED_VALUE_SET).toString();

    private static final String SELECTION_RABP_FT_BLOCKED = new StringBuilder(
            RichAddressBookData.KEY_FT_BLOCKED).append("=")
            .append(RichAddressBookData.BLOCKED_VALUE_SET).toString();
    ...
    public void setContactCapabilities(ContactId contact, Capabilities caps) {
        ...
        // Save the capabilities extensions
        values.put(RichAddressBookData.KEY_CAPABILITY_EXTENSIONS,
                ExtensionManager.getExtensions(caps.getSupportedExtensions()));
    ...
    public Capabilities getContactCapabilities(ContactId contact) {
        ...
        try {
            ...
            // Set RCS extensions capability
            caps.setSupportedExtensions(ExtensionManager.getExtensions(cursor.getString(cursor
                    .getColumnIndexOrThrow(RichAddressBookData.KEY_CAPABILITY_EXTENSIONS))));
    ...
    public long createRcsContact(final ContactInfo info, final long rawContactId) {
        ...
        ops.add(ContentProviderOperation
                ...
                .withValue(
                        Data.DATA2,
                        ExtensionManager.getExtensions(info.getCapabilities()
                                .getSupportedExtensions()))
    ...
    public boolean isImBlockedForContact(ContactId contact) {
        ...
        try {
            Uri uri = Uri.withAppendedPath(RichAddressBookData.CONTENT_URI, contact.toString());
            cursor = mLocalContentResolver.query(uri, PROJECTION_RABP, SELECTION_RAPB_IM_BLOCKED,
                    null, null);
            return cursor.moveToFirst();
    ...
    public boolean isFtBlockedForContact(ContactId contact) {
        ...
        try {
            Uri uri = Uri.withAppendedPath(RichAddressBookData.CONTENT_URI, contact.toString());
            cursor = mLocalContentResolver.query(uri, PROJECTION_RABP, SELECTION_RABP_FT_BLOCKED,
                    null, null);
            return cursor.moveToFirst();
    ...
    private Cursor getRawContactDataCursor(final long rawContactId) {
        ...
        String[] selectionArgs = {
                Long.toString(rawContactId), MIMETYPE_REGISTRATION_STATE, MIMETYPE_NUMBER,
